...
def valid_type(x) :
  if (x == "natural" or x == "food" or x == "waterfront" or
      x == "entertainment" or x == "cultural" or x == "museum" or
      x == "historical" or x == "store" or x == "other") : return True
  else : return False

labels['correct_type'] = labels['correct_type'].apply(lambda x: x if valid_type(x) else "other")
labels.head(10)
